...
function Navigation() {
	...
	return (
		<nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b ${isScrolled ? 'backdrop-blur-md bg-slate-900/80 border-white/10' : 'border-transparent'}`}>
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex items-center justify-between h-20">
					...
					{/* CTA Button */}
					<div className="flex-shrink-0">
						<button className="bg-ocean-800 text-white px-6 py-2.5 rounded-full hover:bg-ocean-700 transform  transition-all duration-300 text-[13px] flex items-center gap-2 uppercase shadow-md hover:shadow-ocean-500/25">
