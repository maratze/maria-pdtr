			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex items-center justify-between h-20">
					...
					<div className="hidden min-[1000px]:block flex-shrink-0">
						<a href="https://t.me/maria_pdtr" target="_blank" className="bg-ocean-600 text-white px-6 py-3 rounded-full hover:bg-ocean-500 transform transition-all duration-300 text-[13px] flex items-center gap-2 shadow-md hover:shadow-ocean-500/25">
