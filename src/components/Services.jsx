				...
				<div id="booking" className="max-w-3xl mx-auto">
					<div className="bg-white/5 backdrop-blur-sm rounded-xl sm:rounded-2xl overflow-hidden border border-white/10 p-4 sm:p-6 md:p-8">
						<div className="text-center mb-6 sm:mb-8">
							<div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-ocean-600/20 rounded-full mb-3 sm:mb-4">
						...
						<div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
							...
							>
								<div className="w-10 h-10 sm:w-12 sm:h-12 bg-ocean-600/20 rounded-full flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-ocean-600/30 transition-colors">
