		...
		<section id="services" className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-ocean-900 py-12 sm:py-16 lg:py-24 overflow-hidden">
			...
			<div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10">
						{services.map((service, index) => (
							<div
								key={service.id}
								className={`
									p-6 transition-all duration-300 hover:bg-white/10
				...
				<div id="booking" className="max-w-3xl mx-auto">
					<div className="bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 p-8">
						<div className="text-center mb-8">
							<div className="inline-flex items-center justify-center w-16 h-16 bg-ocean-600/20 rounded-full mb-4">
								<svg className="w-8 h-8 text-ocean-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						...
						<div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
							...
							<a
								...
								className="flex flex-col items-center p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 group border border-white/5"
							>
								<div className="w-12 h-12 bg-green-600/20 rounded-full flex items-center justify-center mb-3 group-hover:bg-green-600/30 transition-colors">
						...
						<div className="mt-6 p-4 bg-ocean-600/10 rounded-xl border border-ocean-500/20">
				...
				<div className="mt-12 text-center">
					<div className="inline-block bg-white/5 backdrop-blur-sm rounded-xl p-6 max-w-2xl border border-white/10">
						<div className="flex items-start gap-4">
							<div className="flex-shrink-0">
								<svg className="w-6 h-6 text-ocean-300 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
