			...
			<nav className="fixed top-0 left-0 right-0 z-50">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex items-center justify-between h-20">
						...
						{/* CTA Button */}
						<div className="flex-shrink-0">
							<button className="bg-ocean-600 text-white px-6 py-2.5 rounded-full hover:bg-ocean-700 transition-colors duration-200 text-sm flex items-center gap-2 uppercase">
						...
						<div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-center w-full">
							...
							<div className="lg:col-span-6 space-y-8">
								...
								<div className="flex flex-wrap gap-6 text-center">
									<div>
										<div className="text-3xl font-bold text-ocean-600">8+</div>
										<div className="text-sm text-slate-600">лет опыта</div>
									</div>
									<div>
										<div className="text-3xl font-bold text-ocean-600">15+</div>
										<div className="text-sm text-slate-600">семинаров</div>
									</div>
									<div>
										<div className="text-3xl font-bold text-ocean-600">500+</div>
										<div className="text-sm text-slate-600">здоровых клиентов</div>
									</div>
								</div>
								...
								<div className="space-y-4">
									<div className="flex items-start gap-4">
										...
										<div>
											<h4 className="font-semibold text-slate-900">Организация семинаров</h4>
											<p className="text-sm text-slate-600">по обучению методу P-DTR для специалистов</p>
										</div>
									</div>
									...
									<div className="flex items-start gap-4">
										...
										<div>
											<h4 className="font-semibold text-slate-900">Приглашение автора метода</h4>
											<p className="text-sm text-slate-600">P-DTR в Россию для проведения мастер-классов</p>
										</div>
									</div>
									...
									<div className="flex items-start gap-4">
										...
										<div>
											<h4 className="font-semibold text-slate-900">Активное участие</h4>
											<p className="text-sm text-slate-600">в развитии и популяризации метода P-DTR в России</p>
										</div>
									</div>
								</div>
							...
							<div className="absolute bottom-0 right-[-120px] w-[800px] h-[800px]">
